...
# Technology Stack
# Layer Technology Markup HTML5 (semantic tags) Styling Bootstrap 5 + JavaScript Plain JS (no frameworks) Backend JSON Server (mock REST API)DataJSON via fetch + async/await
...
bash npx json-server --watch db.json
You should see:
Resources
